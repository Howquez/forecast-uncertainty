...
You can find the processed data [as an .rda file here](https://github.com/Howquez/forecast-uncertainty/blob/Baillon/data/processed/simulations.rda) or download a .csv file using the button below.
...
grid.arrange(
  ...
  nrow = 1,
  top = "Balance",
  bottom = "Dashed line indicates perfect balance."
)
```
