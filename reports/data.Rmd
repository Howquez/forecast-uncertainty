...
To rerun the code you can download the whole Github repository or the raw data which you can find [here]() or behind the  button below. Note that you'll have to adjust the path accordingly, if you proceed with the latter options.
...
save(data, file = "../data/processed/simulations.rda")
```

# Download

You can find the data [here]() or download it using the button below.
